-- Supabase Splinter Database Linter
-- Source: https://github.com/supabase/splinter
-- Run this query against your Supabase database to identify security,
-- performance, and configuration issues.
--
-- Lint checks included:
--   0001: Unindexed Foreign Keys (PERFORMANCE)
--   0002: Exposed Auth Users (SECURITY)
--   0003: Auth RLS Initialization Plan (PERFORMANCE)
--   0004: No Primary Key (PERFORMANCE)
--   0005: Unused Index (PERFORMANCE)
--   0006: Multiple Permissive Policies (PERFORMANCE)
...
--   0016: Materialized View in API (SECURITY)
--   0017: Foreign Table in API (SECURITY)
--   0018: Unsupported Reg Types (SECURITY)
--   0019: Insecure Queue Exposed in API (SECURITY)
--   0020: Table Bloat (PERFORMANCE)
--   0021: Foreign Key to Auth Unique Constraint (SECURITY)
--   0022: Extension Versions Outdated (SECURITY)
--   0023: Sensitive Columns Exposed (SECURITY)
--   0024: RLS Policy Always True (SECURITY)
